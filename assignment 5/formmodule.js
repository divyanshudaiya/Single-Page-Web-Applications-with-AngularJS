...
function RoutesConfig($stateProvider, $urlRouterProvider) {
		...
		.state('categorie',{
				...
				'          ng-click="catList.reassign() " style="font-size:1.5em;" class="btn btn-default">Submit</button><p ng-if="catList.total">See <a ui-sref="itemi" >info</a></p><p ng-if="catList.total" style="font-size:1.5em;font-weight:bold;color:green;">SIGN UP SUCCESSFULL</p></div></form></fieldset></div>'
